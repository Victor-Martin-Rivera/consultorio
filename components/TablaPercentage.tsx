import { Box, Divider, NumberInput, Paper, Space, Stack, Table, Text } from '@mantine/core'
import { useState } from 'react';
import { getGET } from '../values/formulas';


const TablaPercentage = ({ sex, weight, height, age, factor, formula }: { sex: any, weight: any, height: any, age: any, factor: any, formula: any }) => {
...
export default TablaPercentage